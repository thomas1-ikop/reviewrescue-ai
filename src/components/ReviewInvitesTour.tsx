...
const ReviewInvitesTour: React.FC<ReviewInvitesTourProps> = ({ isOpen, onComplete, onSkip }) => {
  ...
  const steps: TourStep[] = [
    ...
    },
    {
      id: 'qr',
      title: ' QR Code',
      description: 'Generate a QR code that customers can scan to leave a review instantly. Print it and display it in your store for quick, frictionless feedback – no typing needed! Show it to happy customers for an automatic 5 star review! This is a pro feature.',
